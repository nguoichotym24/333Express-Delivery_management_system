  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-secondary mt-2">Quản lý thông tin tài khoản cửa hàng của bạn</p>
      </div>
      ...
      <Card>
        <CardHeader className="flex flex-row items-start justify-between">
          <div>
            ...
            <CardDescription>Thông tin cơ bản của cửa hàng</CardDescription>
          </div>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-secondary">Tên cửa hàng</p>
